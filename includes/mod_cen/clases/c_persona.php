...
class People
{
	...
	private $cellPhone;
 	...
 	function __construct($peopleId=NULL,$tipo=NULL,$dni=NULL,$cuil=NULL,$firstName=NULL,$lastName=NULL,$birthDate=NULL,$gender=NULL,$address=NULL,$telephone=NULL,$cellPhone=NULL,$email=NULL,$dateUpdate=NULL)
	{
			 //seteo los atributos
	...
	public function agregar()
	{
		...
		$sentencia="INSERT INTO personas (peopleId,tipo,dni,cuil,firstName,lastName,birthDate,gender,address,telephone,cellPhone,email,dateUpdate)
		VALUES (NULL,". $this->tipo.",". $this->dni.",". $this->cuil.",'".$this->firstName."','".$this->lastName."','". $this->birthDate."','". $this->gender."','". $this->address."','". $this->telephone."','". $this->cellPhone."','". $this->email."','". $this->dateUpdate."');";
		//echo $sentencia;
